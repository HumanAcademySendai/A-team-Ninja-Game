...
void GameMain::MainPlayer()
{
	...
	//背景移動制限
	if (kaidan4_x < -1280 * 2) {
		floor4_0x = 1280.0f; floor4_1x = 0.0f; floor4_2x = -1280.0f;  kaidan4_x = -1280 * 2;
	}
	if (kaidan4_x > 0) {
...
void GameMain::Draw()
{
	...
	SpriteBatch.Draw(*floor, Vector3(floor4_0x, 0.0f, 0.0f));
	SpriteBatch.Draw(*floor, Vector3(floor4_1x, 0.0f, 0.0f));
	SpriteBatch.Draw(*floor, Vector3(floor4_2x, 0.0f, 0.0f));
	SpriteBatch.Draw(*kaidan, Vector3(kaidan4_x, 0.0f, 0.0f));
